...
// https://help.waterdata.usgs.gov/portal_javascripts/jquery-integration.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/++resource++plone.app.jquerytools.overlayhelpers.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/register_function.js?original=1
var bugRiddenCrashPronePieceOfJunk=(navigator.userAgent.indexOf('MSIE 5')!==-1&&navigator.userAgent.indexOf('Mac')!==-1);var W3CDOM=(!bugRiddenCrashPronePieceOfJunk&&typeof document.getElementsByTagName!=='undefined'&&typeof document.createElement!=='undefined');var registerEventListener=function(elem,event,func){jQuery(elem).bind(event,func)};var unRegisterEventListener=function(elem,event,func){jQuery(elem).unbind(event,func)};var registerPloneFunction=jQuery;
function getContentArea(){var node=jQuery('#region-content,#content');return node.length?node[0]:null}


/* - plone_javascript_variables.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='https://help.waterdata.usgs.gov';var form_modified_message='Your form has not been saved. All changes you have made will be lost.';var form_resubmit_message='You already clicked the submit button. Do you really want to submit this form again?';var external_links_open_new_window='false';var mark_special_links='false';var ajax_noresponse_message='No response from server. Please try again later.';

/* - modernizr.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/modernizr.js?original=1
...
/* - nodeutilities.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/cookie_functions.js?original=1
...
/* - livesearch.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/livesearch.js?original=1
...
/* - select_all.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/select_all.js?original=1
...
/* - dragdropreorder.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/dragdropreorder.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/collapsiblesections.js?original=1
...
/* - form_tabbing.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/form_tabbing.js?original=1
...
/* - popupforms.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/popupforms.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/jquery.highlightsearchterms.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/first_input_focus.js?original=1
jQuery(function($){if($("form div.error :input:first").focus().length){return}
$("form.enableAutoFocus :input:not(.formTabs):visible:first").focus()});

/* - accessibility.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/accessibility.js?original=1
...
/* - styleswitcher.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/styleswitcher.js?original=1
...
/* - toc.js - */
// https://help.waterdata.usgs.gov/portal_javascripts/toc.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/collapsibleformfields.js?original=1
...
// https://help.waterdata.usgs.gov/portal_javascripts/++resource++plone.app.discussion.javascripts/comments.js?original=1
